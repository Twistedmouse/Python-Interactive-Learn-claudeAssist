...
const InteractiveLearningRoadmap = () => {
  ...
  const hybridTopics = {
    ...
    "3-0": true, // LLMs vs SLMs (was moved to first)
    "3-1": true, // OpenAI & Anthropic APIs (was position 0)
    "3-2": true, // Prompt Engineering (was position 1)
    "3-3": true, // Structured Outputs (was position 2)
    "3-4": true, // Chaining & Multi-Step (was position 3)
    "3-5": true, // LangChain (was position 4)
    "3-6": true, // Vector Databases (was position 5)
    "3-7": true, // AI Agents (was position 6)
    "4-0": true, // FastAPI
    "4-1": true, // Streamlit
    "4-2": true, // Docker
    "4-3": true, // Environment Variables
    "4-5": true, // Documentation
    "4-6": true, // Infrastructure: Cloud vs Local (was moved before Cloud Deployment)
    "4-7": true, // Cloud Deployment (was position 6)
  };
